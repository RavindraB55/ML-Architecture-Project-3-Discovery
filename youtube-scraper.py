...
def setup(api_path, code_path):
    with open(api_path, 'r') as file:
        api_key_temp = file.readline()

    with open(code_path) as file:
        country_codes_temp = [x.rstrip() for x in file]

    return api_key_temp, country_codes_temp
